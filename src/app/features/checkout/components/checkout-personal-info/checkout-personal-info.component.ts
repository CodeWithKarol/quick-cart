      ...
      <div>
        ...
        <div class="relative mt-6">
          ...
          <div class="relative flex justify-center">
            <span class="bg-gray-50 px-2 text-sm text-gray-500">Or continue with email</span>
          </div>
        </div>
      </div>
        ...
        <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6 pl-1">
          ...
          <div class="sm:col-span-2">
            ...
            @if (form().get('city')?.touched && form().get('city')?.invalid) {
              <p class="mt-2 text-sm text-red-600">City is required</p>
            }
          </div>
          ...
          <div class="sm:col-span-2">
            ...
            @if (form().get('zipCode')?.touched && form().get('zipCode')?.invalid) {
              <p class="mt-2 text-sm text-red-600">ZIP Code is required</p>
            }
          </div>
        </div>
      </div>
